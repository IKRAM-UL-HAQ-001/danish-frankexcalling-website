...
class WalkExport implements FromQuery, WithHeadings, WithStyles, WithColumnWidths, WithMapping
{
    use Exportable;
    ...
    public function map($walk): array
    {
        return [
            $walk->id,
            $this->decryptData($walk->exchange_name),
            $this->decryptData($walk->user_name),
            $this->decryptData($walk->name),
            $this->decryptData($walk->phone->phone_number),
            $this->decryptData($walk->feedback),
            $this->decryptData($walk->amount),
            $walk->created_at,
            $walk->updated_at,
        ];
    }
