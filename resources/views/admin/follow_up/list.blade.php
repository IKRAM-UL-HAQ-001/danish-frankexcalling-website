                                            ...
                                            <td style="width: 10%; text-align: center;">
                                                <div class="d-flex justify-content-center ">
                                                    ...
                                                    <button type="button" class="btn btn-info btn-sm edit-button mx-3"
                                                        data-id="{{ $FollowUp->id }}" data-name="{{ $FollowUp->name }}"
                                                        data-phone="{{ $FollowUp->phone->phone_number }}"
                                                        data-feedback="{{ $FollowUp->feedback }}"
                                                        data-amount="{{ $FollowUp->amount }}">
                                                        Edit
                                                    </button>
                                                </div>
                                            </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-white" id="editDemoSendModalLabel">Edit Follow Up Data</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('editDemoSendForm').addEventListener('submit', function(event) {
                ...
                formData.append('task_name', 'followup');
