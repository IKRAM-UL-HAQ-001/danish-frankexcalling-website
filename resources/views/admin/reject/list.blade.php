                                ...
                                <tbody id="DataTableBody">
                                    @foreach ($Rejects as $reject)
                                        <tr data-user-id="a" data-exchange-id="a">
                                            <td style="width: 45%;" class="encrypted-data">{{ $reject->user->name }}</td>
                                            <td style="width: 45%;" class="encrypted-data">{{ $reject->exchange->name }}
                                            </td>
                                            <td style="width: 45%;" class="encrypted-data">{{ $reject->name }}</td>
                                            <td style="width: 45%;" class="encrypted-data">
                                                {{ $reject->phone->phone_number ?? null }}</td>
                                            <td style="width: 45%;" class="encrypted-data">{{ $reject->feedback }}</td>
                                            ...
                                            <td style="width: 10%; text-align: center;">
                                                <div class="d-flex justify-content-center ">
                                                    ...
                                                    <button type="button" class="btn btn-info btn-sm edit-button mx-3"
                                                        data-id="{{ $reject->id }}" data-name="{{ $reject->name }}"
                                                        data-phone="{{ $reject->phone->phone_number ?? null }}"
                                                        data-feedback="{{ $reject->feedback }}"
                                                        data-amount="{{ $reject->amount }}">
                                                        Edit
                                                    </button>
                                                </div>
                                            </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header d-flex justify-content-between align-items-center " style="background:#acc301;">
                    <h5 class="modal-title" id="exportModalLabel" style="color:white">Export Reject</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-white" id="editDemoSendModalLabel">Edit Reject Data</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById('editDemoSendForm').addEventListener('submit', function(event) {
                ...
                formData.append('task_name', 'reject');
