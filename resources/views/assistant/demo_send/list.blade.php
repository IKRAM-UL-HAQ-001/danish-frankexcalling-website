                                ...
                                <tbody id="DataTableBody">
                                    @foreach ($DemoSends as $DemoSend)
                                        <tr data-user-id="a" data-exchange-id="a">
                                            <td class="encrypted-data">{{ $DemoSend->user->name }}</td>
                                            <td class="encrypted-data">{{ $DemoSend->exchange->name }}</td>
                                            <td class="encrypted-data">{{ $DemoSend->name }}</td>
                                            <!-- <td class="encrypted-data">{{ $DemoSend->phone->phone_number }}</td> -->
                                            <td class="encrypted-data">{{ $DemoSend->feedback }}</td>
                                            <td class="encrypted-data">{{ $DemoSend->amount }}</td>
                                            <td>{{ $DemoSend->created_at }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center " style="background:#acc301;">
                <h5 class="modal-title" id="exportModalLabel" style="color:white">Export Follow Up</h5>
