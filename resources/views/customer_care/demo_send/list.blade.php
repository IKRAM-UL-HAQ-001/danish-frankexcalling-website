                        ...
                        <table  class="table align-items-center mb-0 table-striped table-hover px-2">
                            ...
                            <tbody id="DataTableBody">
                                ...
                                <tr data-user-id="a" data-exchange-id="a">
                                    ...
                                    <td style="width: 45%;" class="">{{$DemoSend->created_at}}</td>
                                    <td style="width: 45%;" ><button class="btn btn-primary btn-sm open-modal-btn" data-bs-toggle="modal"
                                        data-bs-target="#addPhoneNumberModal"
                                        data-id = {{$DemoSend->phone_id}}
