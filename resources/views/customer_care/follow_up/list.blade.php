                ...
                <div class="flex-grow-1 d-flex flex-column justify-content-center align-items-center col-12">
                    <div class="card-body px-0 pb-2 px-3 col-12">
                        <div class="table-responsive p-0">
                            <table id="DataTables" class="table align-items-center mb-0 table-striped table-hover px-2">
                                <thead>
                                    <tr>
                                ...
                                <tbody id="DataTableBody">
                                    @foreach ($FollowUps as $FollowUp)
                                        <tr data-user-id="a" data-exchange-id="a">
                                            ...
                                            <td  class="encrypted-data">{{ $FollowUp->feedback }}</td>
                                            <td  class="encrypted-data">{{ $FollowUp->amount }}</td>
