                                ...
                                <tbody id="DataTableBody">
                                    @foreach ($ReferIds as $referId)
                                        <tr data-user-id="a" data-exchange-id="a">
                                            <td class="encrypted-data">{{ $referId->name }}</td>
                                            <td class="encrypted-data">{{ $referId->phone->phone_number  ?? ''}}</td>
                                            <td class="encrypted-data">{{ $referId->feedback }}</td>
                                            <td class="encrypted-data">{{ $referId->amount }}</td>
                                            <td>{{ $referId->created_at }}</td>
                                            <td><button class="btn btn-primary btn-sm open-modal-btn"
                                                    data-bs-toggle="modal" data-bs-target="#addPhoneNumberModal"
                                                    data-id = {{$referId->phone_id}}
