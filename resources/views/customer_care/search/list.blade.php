                            ...
                            <div class="row mb-3 d-flex justify-content-end">
                                <div class="col-md-4 mr-2">
                                    <form method="POST" id="searchFormDataEntry" class="d-flex"
                                        action="{{ route('customer_care.searchDataEntry.post') }}">
                                        @csrf
                                    ...
                                    @else
                                        @foreach ($DataSearch as $followup)
                                            <tr data-user-id="a" data-exchange-id="a">
                                                <td style="width: 45%;" class="encrypted-data">{{ $followup->user->name }}
                                                </td>
                                                <td style="width: 45%;" class="encrypted-data">
                                                    {{ $followup->exchange->name }}</td>
                                                <td style="width: 45%;" class="encrypted-data">{{ $followup->name }}</td>
                                                <td style="width: 45%;" class="encrypted-data">
                                                    {{ $followup->phone->phone_number }}</td>
                                                ...
                                                @if ($userId == $followup->user_id)
                                                    <td style="width: 45%;" class="encrypted-data">
                                                        <button class="btn btn-primary btn-sm open-modal-btn"
                                                            data-bs-toggle="modal" data-bs-target="#addPhoneNumberModal"
                                                            data-id="{{ $followup->phone_id }}"
                                                            data-phone="{{ $followup->phone->phone_number }}">
                                                            Form
                                                        </button>
                                                    </td>
                                                @endif
                ...
                <div class="modal-body">
                    <form id="addPhoneForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border px-3" id="customer_name"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border px-3 customer_phone encrypted-data"
                                id="customer_phone" name="customer_phone" required readonly>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control border px-3" id="feedback"
                                name="customer_feedback" placeholder="Enter Feedback" required>
                        </div>
                        <div class="mb-3">
