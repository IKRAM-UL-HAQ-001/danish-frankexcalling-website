                            ...
                            <div class="row mb-3 d-flex justify-content-end">
                                <div class="col-md-4 mr-2">
                                    <form method="POST" id="searchFormDataEntry" class="d-flex"
                                        action="{{ route('exchange.searchDataEntry.post') }}">
                                        @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="demo_send_btn" class="btn btn-warning"
                        data-action="{{ route('exchange.data_entry.post') }}">Demo Send</button>
                    <button type="button" id="reject_btn" class="btn btn-warning"
                        data-action="{{ route('exchange.data_entry.post') }}">Reject</button>
                    <button type="button" id="refer_id_btn" class="btn btn-warning"
                        data-action="{{ route('exchange.data_entry.post') }}">Refer ID</button>
                    <button type="button" id="new_id_btn" class="btn btn-success"
                        data-action="{{ route('exchange.data_entry.post') }}">New Id</button>
                    <button type="button" id="follow_up_btn" class="btn btn-info"
                        data-action="{{ route('exchange.data_entry.post') }}">Follow Up</button>
                    <button type="button" id="complaint_btn" class="btn btn-dark"
                        data-action="{{ route('exchange.data_entry.post') }}">Complaint</button>
                    <button type="button" id="walk_btn" class="btn btn-primary"
                        data-action="{{ route('exchange.data_entry.post') }}">Walk</button>
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
